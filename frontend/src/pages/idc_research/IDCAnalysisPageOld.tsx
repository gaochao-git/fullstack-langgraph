...
import { Card, Badge, Tabs, Button, Space, Row, Col } from 'antd';
import { DatabaseOutlined, DesktopOutlined, ReloadOutlined, FullscreenExitOutlined } from '@ant-design/icons';
        ...
        <Card>
          <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: 24 }}>
            <Tabs
              ...
              onChange={(key) => setCurrentView(key as 'overview' | 'comparison' | 'applications' | 'substitution')}
              type="card"
              items={[
                {
                  label: '数据中心概览',
          ...
          {currentView === 'substitution' && (
            <div style={{ display: 'flex', flexDirection: 'column', gap: 24 }}>
              <div>
                <h3 style={{ marginBottom: 8 }}>国产替代监控</h3>
                <p style={{ color: '#666', marginBottom: 16 }}>
