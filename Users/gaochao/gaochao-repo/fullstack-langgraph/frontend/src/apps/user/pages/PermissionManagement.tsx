...
import { Card, Table, Button, Space, Input, Modal, Form, message, Tabs } from 'antd';
    ...
    <div>
      ...
      >
        <Form form={form} layout="vertical">
          ...
          >
            <Form.Select>
              <Form.Select.Option value="menu">菜单权限</Form.Select.Option>
              <Form.Select.Option value="button">按钮权限</Form.Select.Option>
              <Form.Select.Option value="api">接口权限</Form.Select.Option>
            </Form.Select>
          </Form.Item>
        </Form>
      </Modal>
